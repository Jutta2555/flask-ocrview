...
KEYWORDTYPE2={
    'คำนำหน้าชื่อ':['สกุล '],
    'คำปิดท้ายชื่อ':[' เพศ '],
    'คำนำหน้าบัตร':['ประชาชน '],

    'คำนำหน้าเกิด ':['เกิด '],

    'คำนำหน้าสัญชาติ':['ชาติ '],

    'คำนำหน้าสถานะบ้าน':['ในบ้าน '],

    'คำนำหน้าพ่อ':['บดา ','บิดา '],
    'คำนำหน้าบัตรพ่อ':['บดา ','บิดา '],

    'คำนำหน้าแม่':['มารดา ','มารดา '],
    'คำนำหน้าบัตรแม่':['มารดา ','มารดา '],

    'คำนำที่อยู่':['จุบัน ','จบัน ','จบน ']
    ...
    for linenumber, linetextlaw in enumerate(Aprocessstring ) :
        ...
        # for k,v in sort_by_value.items():
            ...
            if len(k) > 1 :# Count group of word more than 1 chr
                GrpWord += 1
                if len(k) > 5 : # Count group of word more than 5 chr
